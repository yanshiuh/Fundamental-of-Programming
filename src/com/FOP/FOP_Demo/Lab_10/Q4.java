...
class Appointment implements Searchable {
    ...
    public void saveAppointment() {
        try {
            ...
            // keep saving new appointment
            PrintWriter saveText = new PrintWriter(new FileOutputStream("appointment.txt" ,true));

            //store the appointment in the textfile
            saveText.println(this.dateStartTime);
            saveText.println(this.dateEndTime);
            saveText.println();
            saveText.close();
    ...
    public static boolean search(String dateStartTime, String dateEndTime) {
        try {
            Scanner readText = new Scanner(new FileInputStream("appointment.txt"));
            ...
            while (readText.hasNextLine()) {
                String[] appointmentDateStartTime = readText.nextLine().split("/");
                String[] appointmentDateEndTime = readText.nextLine().split("/");
                readText.nextLine();
